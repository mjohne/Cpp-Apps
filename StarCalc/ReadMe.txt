========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : StarCalc
========================================================================


AppWizard has created this StarCalc application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your StarCalc application.
...
StarCalc.h
    ...
    CStarCalcApp application class.
...
res\StarCalc.ico
    ...
    icon is included by the main resource file StarCalc.rc.
...
StarCalcDlg.h, StarCalcDlg.cpp - the dialog
    These files contain your CStarCalcDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in StarCalc.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CStarCalcDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named StarCalc.pch and a precompiled types file named StdAfx.obj.
