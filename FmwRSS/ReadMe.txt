========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : FmwRSS
========================================================================


AppWizard has created this FmwRSS application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your FmwRSS application.
...
res\FmwRSS.ico
    ...
    icon is included by the main resource file FmwRSS.rc.
...
FmwRSSDlg.h, FmwRSSDlg.cpp - the dialog
    These files contain your CFmwRSSDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in FmwRSS.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CFmwRSSDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named FmwRSS.pch and a precompiled types file named StdAfx.obj.
