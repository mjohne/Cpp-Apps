========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : UPXGuy
========================================================================


AppWizard has created this UPXGuy application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your UPXGuy application.
...
res\UPXGuy.ico
    ...
    icon is included by the main resource file UPXGuy.rc.
...
UPXGuyDlg.h, UPXGuyDlg.cpp - the dialog
    These files contain your CUPXGuyDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in UPXGuy.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CUPXGuyDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named UPXGuy.pch and a precompiled types file named StdAfx.obj.
